    ...
    >
      ...
      <div className="container">
        ...
        <div className="-mx-4 flex flex-wrap justify-between">
          ...
          <div className="w-full px-4 lg:px-12 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
            <div className="mb-5 w-full">
              ...
              <ul>
                <li>
                  <a
                    href="/projects"
                    className="mb-2 inline-block text-base text-gray-500 hover:text-primary"
                  >
                    Buy a Home
                  </a>
                </li>
          ...
          <div className="w-full px-4 lg:px-12 sm:w-1/2 md:w-1/2 lg:w-3/12 xl:w-2/12">
            <div className="mb-5 w-full">
          ...
          <div className="w-full px-4 lg:px-12 md:w-2/3 lg:w-6/12 xl:w-2/12">
